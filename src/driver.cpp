...
int main(int argc, char **argv)
{
    ...
    //test
    //./lifelong --inputFile ../lifelong_benchmark/random/agent-400_scen-delay-0.010-1.json --simulationTime 300 -c 3 --mapfPlanner 2 --delayPolicy 3  --delaySimulateAll false -l log.txt -o test_3_pibtd.json --planTimeLimit 3  >test_3_pibtd.txt
