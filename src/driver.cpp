...
int main(int argc, char **argv)
{
    ...
    //test
    //./lifelong --inputFile ../lifelong_benchmark/random/agent-400_scen-delay-0.010-1.json --simulationTime 100 -c 1 --mapfPlanner 2 --delayPolicy 3  --delaySimulateAll false -l log.txt -o test_1_pibtd.json --planTimeLimit 1  >test_1_pibtd.txt
