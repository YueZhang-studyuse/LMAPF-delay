...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help", "produce help message")
        ...
        ("initTimeLimit", po::value<int>()->default_value(1), "the time limit for planner in seconds")
    ...
    //test
    //./lifelong --inputFile ../lifelong_benchmark/warehouse-s/agent-1400_scen-delay-0.004-1.json --simulationTime 100 -c 3 --mapfPlanner 2 --delayPolicy 3  --delaySimulateAll false -l log.txt -o test_3_pibtd.json --planTimeLimit 3  >test_3_pibtd.txt
