...
public:
	...
	virtual Path findPath(const ConstraintTable& constraint_table, double timeout, bool &timeout_flag,int w) = 0;
	virtual Path findPathforSIPPS(const ConstraintTable& constraint_table, double timeout, bool &timeout_flag, int collision_free_window) = 0;
